      ...
      <div className="relative z-10 px-4" style={{ marginTop: "16px" }}>
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-0 flex-1 w-full max-w-full">
            ...
            <aside className="w-24 md:w-32 border-r bg-card/50 backdrop-blur-sm flex-shrink-0 sticky self-start" style={{ top: '214px', maxHeight: 'calc(100vh - 214px)', overflowY: 'auto' }}>
