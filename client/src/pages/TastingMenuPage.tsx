...
// Define interfaces locally (not exported from @shared/schema)
interface Category {
  id: string;
  name: string;
  image_url: string;
        ...
        <div className="relative z-10 px-4" style={{ marginTop: "0px", paddingTop: "0px" }}>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-0 flex-1 w-full max-w-full">
              ...
              <aside className="w-20 md:w-24 border-r bg-card/50 backdrop-blur-sm flex-shrink-0 sticky self-start" style={{ top: isMd ? '312px' : '264px', maxHeight: isMd ? 'calc(100vh - 312px)' : 'calc(100vh - 264px)', overflowY: 'auto' }}>
                    ...
                    {filteredAndSortedDishes.map((dish) => (
                      ...
                      >
                        ...
                        <div className="p-3 md:p-4">
                          ...
                          <div className="mb-3">
                            <p className={cn("text-xs text-muted-foreground", !expandedDescriptions.has(dish.id) && "line-clamp-2")} data-testid={`text-dish-description-${dish.id}`}>
                              {dish.description}
                            </p>
                            {dish.description && dish.description.length > 80 && (
                              ...
                              >
                                {expandedDescriptions.has(dish.id) ? 'less' : '...more'}
                              </button>
                            )}
                          </div>
