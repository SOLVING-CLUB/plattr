                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ₹{parseFloat(selectedDish.price as string).toFixed(0)} {selectedDish.quantity || 'per serving'}
                    </p>
...
// import { useRoute, useLocation } from "wouter";
// import { ChevronDown, Plus, Minus, Leaf, Drumstick, SlidersHorizontal, ArrowUpDown, X, Sparkles, ArrowLeft, LayoutGrid, Circle, Egg, MapPin, Search, ShoppingCart, Star } from "lucide-react";
// import { Button } from "@/components/ui/button";
// import { Badge } from "@/components/ui/badge";
// import { Card } from "@/components/ui/card";
// import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from "@/components/ui/dialog";
...
// // Promotional banner
// import special26BannerImage from '@assets/image_1762505783962.png';
...
//   return (
//     <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
//       {/* Custom Header with Location */}
//       <header className="p-4 shadow-lg text-white" style={{ background: 'linear-gradient(180deg, #5E2E01 0%, #D6931E 50%, #E4AC31 100%)' }}>
...
//               <span className="font-bold text-base">JP Nagar Metro Station</span>
//               <ChevronDown className="w-5 h-5" />
//             </div>
//             <p className="text-xs text-white/80 ml-7">Jaya Prakash Nagar, Kanakapur Main Rd...</p>
//           </div>
          
//           <Button 
//             size="icon" 
//             variant="ghost" 
//             className="relative flex-shrink-0 hover:bg-white/10 text-white"
//             onClick={() => setShowPlatter(true)}
...
//             {totalCartItems > 0 && (
//               <Badge 
//                 className="absolute -top-1 -right-1 h-5 w-5 flex items-center justify-center p-0 rounded-full bg-orange-600 text-white"
...
//           <Button 
//             size="default"
//             className="rounded-2xl bg-orange-600 text-white min-w-[100px] shadow-md font-bold px-8"
//             data-testid="pill-mains"
//           >
//             Mains
//           </Button>
//           <Button 
//             size="default"
//             variant="ghost"
//             className="rounded-2xl bg-amber-200 text-amber-900 min-w-[100px] shadow-md font-bold px-8"
//             data-testid="pill-tiffins"
//           >
//             Tiffins
//           </Button>
//           <Button 
...
//             variant="outline" 
//             size="sm"
//             className="bg-white hover:bg-gray-50 text-gray-900 rounded-xl px-4 whitespace-nowrap border-0 shadow-sm h-11"
//             data-testid="dropdown-cuisines"
//           >
//             <span className="font-semibold">All Cuisines</span>
...
//             <Input 
//               placeholder="Search" 
//               className="pl-11 bg-white text-gray-900 rounded-xl border-0 shadow-sm h-11"
//               value={searchQuery || ''}
...
//             variant="outline"
//             className={cn(
//               "rounded-xl border-0 shadow-sm px-5 whitespace-nowrap font-bold h-11",
//               dietaryMode === 'veg' ? "bg-green-500 text-white" : "bg-white hover:bg-gray-50 text-gray-900"
//             )}
//             onClick={() => setDietaryMode(dietaryMode === 'veg' ? 'all' : 'veg')}
//             data-testid="toggle-veg"
//           >
//             <Circle className={cn(
//               "w-3 h-3 mr-2",
//               dietaryMode === 'veg' ? "fill-white text-white" : "fill-green-600 text-green-600"
//             )} />
//             VEG
//           </Button>
//         </div>
...
//         <div className="relative w-full h-40 overflow-hidden" data-testid="banner-special-offers" style={{
//           clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 15px), 95% 100%, 90% calc(100% - 10px), 85% 100%, 80% calc(100% - 10px), 75% 100%, 70% calc(100% - 10px), 65% 100%, 60% calc(100% - 10px), 55% 100%, 50% calc(100% - 10px), 45% 100%, 40% calc(100% - 10px), 35% 100%, 30% calc(100% - 10px), 25% 100%, 20% calc(100% - 10px), 15% 100%, 10% calc(100% - 10px), 5% 100%, 0 calc(100% - 15px))'
//         }}>
//           <img 
//             src={special26BannerImage}
...
//       <main className="flex gap-0 flex-1 w-full max-w-full overflow-hidden bg-white dark:bg-gray-900">
//         {/* Left Sidebar - Category Filters with circular images */}
//         <aside className="w-20 md:w-24 border-r bg-gradient-to-b from-orange-50/50 to-white dark:from-gray-800 dark:to-gray-900 flex-shrink-0 overflow-y-auto pb-36 md:pb-6">
//           <div className="flex flex-col py-3">
//             {/* All option */}
//             <button
...
//               className={cn(
//                 "flex flex-col items-center gap-2 py-4 px-2 transition-all relative",
//                 selectedCategory === 'all' && "bg-orange-100 dark:bg-orange-900/20"
//               )}
//               data-testid="filter-category-all"
//             >
//               <div className={cn(
//                 "relative w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden border-3 transition-all flex items-center justify-center bg-orange-100 dark:bg-orange-900/30",
...
//                   selectedCategory === 'all' ? "text-orange-600" : "text-orange-400"
//                 )} />
//               </div>
//               <div className="text-center w-full px-1">
//                 <span className={cn(
//                   "text-[10px] md:text-xs font-bold block line-clamp-1 leading-tight",
//                   selectedCategory === 'all' ? "text-orange-600 dark:text-orange-400" : "text-gray-600 dark:text-gray-400"
//                 )}>
//                   All
//                 </span>
//                 <span className={cn(
//                   "text-[9px] md:text-[10px] font-medium text-gray-500 dark:text-gray-400"
//                 )}>
//                   {allDishes.length}
//                 </span>
//               </div>
...
//             {/* Category options */}
//             {categories.map((cat) => {
//               const totalInCategory = allDishes.filter(d => d.categoryId === cat.id).length;
...
//                   className={cn(
//                     "flex flex-col items-center gap-2 py-4 px-2 transition-all relative",
//                     selectedCategory === cat.id && "bg-orange-100 dark:bg-orange-900/20"
//                   )}
//                   data-testid={`filter-category-${cat.id}`}
//                 >
//                   <div className={cn(
//                     "relative w-14 h-14 md:w-16 md:h-16 rounded-full overflow-hidden border-3 transition-all",
//                     selectedCategory === cat.id
//                       ? "border-orange-500 shadow-lg scale-105 ring-2 ring-orange-500/30" 
//                       : "border-orange-200 dark:border-orange-800"
//                   )}>
...
//                   <div className="text-center w-full px-1">
//                     <span className={cn(
//                       "text-[10px] md:text-xs font-bold block line-clamp-2 leading-tight",
//                       selectedCategory === cat.id ? "text-orange-600 dark:text-orange-400" : "text-gray-600 dark:text-gray-400"
//                     )}>
//                       {cat.name}
//                     </span>
//                     <span className={cn(
...
//         {/* Right Content - Dishes Grid */}
//         <div className="flex-1 py-4 md:py-6 min-w-0 overflow-y-auto overflow-x-hidden pb-20 md:pb-6 bg-gradient-to-b from-orange-50/30 to-white dark:from-gray-900 dark:to-gray-900">
        
//         {/* Section Title */}
//         <div className="mb-4 flex justify-between items-center gap-2 flex-wrap px-3 md:px-4">
//           <h2 className="text-xl font-bold font-serif" data-testid="text-section-title">
//             {categories.find(c => c.id === selectedCategory)?.name || 'Starters'}
//           </h2>
...
//         <div className="mb-4 flex items-center gap-2 flex-wrap px-3 md:px-4">
//           {/* Filter Button */}
//           <Button
//             variant="outline"
//             size="sm"
//             className="h-9 gap-1.5 bg-white dark:bg-gray-800 rounded-md border-gray-300"
//             onClick={() => setFilterDialogOpen(true)}
//             data-testid="button-filter"
//           >
//             <SlidersHorizontal className="w-4 h-4" />
...
//           {/* Selected Tags */}
//           <Badge variant="outline" className="bg-white dark:bg-gray-800 px-3 py-1 rounded-md border-gray-300 flex items-center gap-2">
//             <Circle className="w-3 h-3 fill-orange-500 text-orange-500" />
//             Onion
//           </Badge>
...
//           <Button
//             size="lg"
//             className="gap-2 bg-orange-600 text-white ml-auto rounded-md px-6"
//             onClick={() => setPlatterPlannerOpen(true)}
//             data-testid="button-platter-planner"
//           >
...
//               <Card 
//                 key={dish.id} 
//                 className="overflow-hidden hover-elevate group bg-white dark:bg-gray-800 rounded-2xl shadow-md max-w-md"
//                 data-testid={`card-dish-${dish.id}`}
//               >
//                 <div 
...
//                   <div className="absolute top-3 left-3 w-6 h-6 border-2 border-white flex items-center justify-center bg-white rounded-sm">
...
//                   {/* Rating Badge */}
//                   <div className="absolute bottom-3 left-3 bg-white text-gray-900 px-2.5 py-1.5 rounded-md flex items-center gap-1.5 text-sm font-bold shadow-md">
//                     <Star className="w-4 h-4 fill-green-600 text-green-600" />
//                     {(3.7 + Math.random() * 1.1).toFixed(1)}
//                     <span className="text-xs">({Math.floor(Math.random() * 80) + 20})</span>
//                   </div>
//                 </div>
                
//                 <div className="p-4">
//                   <h3 className="font-bold text-base mb-2 text-gray-900 dark:text-white" data-testid={`text-dish-name-${dish.id}`}>
//                     {dish.name}
//                   </h3>
                  
//                   <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 mb-2" data-testid={`text-dish-description-${dish.id}`}>
//                     {dish.description || 'Delicious, marinated with spices and grilled to perfection.'}
//                   </p>
...
//                         openDishDetail(dish);
//                       }}
//                       className="text-sm text-orange-600 hover:underline font-semibold mb-3"
//                       data-testid={`button-toggle-description-${dish.id}`}
//                     >
//                       ...more
//                     </button>
...
//                     <span className="text-orange-600 font-bold text-xl" data-testid={`text-dish-price-${dish.id}`}>
//                       ₹{parseFloat(dish.price as string).toFixed(0)}
//                     </span>
...
//                       size="default"
//                       onClick={() => handleAdd(dish.id)}
//                       variant={cartItemMap[dish.id] ? "ghost" : "default"}
//                       className={cn(
//                         "rounded-md px-6 font-bold",
//                         cartItemMap[dish.id] 
